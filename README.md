...
Contoh sederhana yang menerapkan managemen data dengan menggunakan Redux Saga didalam contoh aplikasi Tugas3
...
- Selanjutnya, Unduh repository ini dengan menekan tombol `Code` berwarna Hijau diatas atau tekan [Unduh](https://github.com/hariandoMuthi/Tugas4-Redux-Saga_120140004)
...
- Kemudian akses link berikut : [LINK](https://snack.expo.dev/@hariandomuthi/tugas4saga_120140004)
